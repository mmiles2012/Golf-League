...
export const SCORING_MODES = [
  {
    ...
    description: 'System calculates points based on positions and scores',
  },
  {
    value: 'manual',
    label: 'Manual Points',
    description: 'Admin directly assigns points to players',
  },
];
...
export const SCORING_TYPES = [
  ...
  {
    value: 'both',
    label: 'Both Net and Gross',
    fields: ['position', 'netScore', 'grossScore', 'handicap'],
  },
];
