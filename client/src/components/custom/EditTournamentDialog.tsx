  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await apiRequest(
        'PUT',
        `/api/tournaments/${tournamentId}/edit`,
        tournamentData,
      );
                      ...
                      <TableRow key={result.id}>
                        ...
                        <TableCell className="text-center">
                          <Input
                            ...
                            onChange={(e) =>
                              handleResultChange(result.id, 'position', e.target.value)
                            }
                        ...
                        <TableCell className="text-center">
                          <Input
                            ...
                            onChange={(e) =>
                              handleResultChange(result.id, 'grossScore', e.target.value)
                            }
                            className="w-16 text-center"
                            disabled={isSaving}
                          />
                        ...
                        <TableCell className="text-center">
                          <Input
                            ...
                            onChange={(e) =>
                              handleResultChange(result.id, 'handicap', e.target.value)
                            }
                            className="w-16 text-center"
                            disabled={isSaving}
                          />
                        ...
                        <TableCell className="text-center">
                          <Input
                            ...
                            onChange={(e) =>
                              handleResultChange(result.id, 'netScore', e.target.value)
                            }
                            className="w-16 text-center"
                            disabled={isSaving}
                          />
                        ...
                        <TableCell className="text-center font-medium">
                          {(() => {
                            ...
                            const sortedByGrossScore = [...results].sort(
