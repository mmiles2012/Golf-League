        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {player ? (
              ...
              <>
                <p className="text-sm text-muted-foreground">
                  Link your account to your tournament player profile to see your statistics and history.
                </p>
      ...
      {isEditing && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select players to include in your friends leaderboard
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Select value={selectedScoreType} onValueChange={(value: 'net' | 'gross') => setSelectedScoreType(value)}>
                ...
                <TableBody>
                  {friendsLeaderboard.map((player: PlayerWithHistory, index: number) => (
                    <TableRow key={player.player.id}>
                      ...
                      <TableCell>
                        {selectedScoreType === 'net' ? player.top8TotalPoints || 0 : player.grossTop8TotalPoints || 0}
                      </TableCell>
      ...
      {playerHistory && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your tournament results sorted by performance
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* Top 8 Events */}
                  ...
                  <TableBody>
                    {top8Events.map((tournament: any) => (
                      <TableRow key={tournament.id} className="bg-yellow-50">
                        ...
                        <TableCell>{new Date(tournament.tournamentDate).toLocaleDateString()}</TableCell>
                        <TableCell>
                          <Badge variant={tournament.position <= 3 ? "default" : "secondary"}>
                            {tournament.position <= 10 && tournament.position > 1 ? `T${tournament.position}` : tournament.position}
                          </Badge>
                        </TableCell>
            ...
            {droppedEvents.length > 0 && (
              <div>
                ...
                <div className="flex items-center mb-3">
                  <h3 className="font-semibold text-muted-foreground">Additional Events (Not counting toward Overall Points)</h3>
                </div>
                <Table>
                  <TableHeader>
                    <TableRow>
