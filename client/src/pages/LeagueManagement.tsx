      ...
      {isLoading ? (
          ...
          <CardContent className="flex flex-col items-center justify-center py-10 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-neutral-500 max-w-md mt-1">
                Create your first league to get started. Each league can have its own tournaments
                and leaderboards.
              </p>
              <Button
                className="mt-4"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {leagues.map((league: any) => (
            <Card
              key={league.id}
              className={`overflow-hidden ${!league.isActive ? 'opacity-75' : ''}`}
            >
              <CardHeader className="pb-2">
              ...
              <CardFooter className="flex justify-between">
                ...
                <Button variant="destructive" onClick={() => handleDeleteClick(league)}>
      ...
      <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Enter the details of your new golf league.</DialogDescription>
          </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Optionally add a season year or name</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>Whether this league is currently active</FormDescription>
                    </div>
                    <FormControl>
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>Update the details of {currentLeague?.name}</DialogDescription>
          </DialogHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onEditSubmit)} className="space-y-4">
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={editLeagueMutation.isPending}>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the league "{currentLeague?.name}" and all its associated
