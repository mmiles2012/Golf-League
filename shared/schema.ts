...
export const users = pgTable('users', {
  ...
  role: varchar('role', { enum: ['player', 'admin', 'super_admin'] })
    .default('player')
    .notNull(),
  displayName: varchar('display_name'),
  homeClub: varchar('home_club', { length: 32 }),
...
export const playerLinkRequests = pgTable(
...
export const playerLinkRequestSchema = createInsertSchema(playerLinkRequests)
  .omit({
    id: true,
    requestedAt: true,
    reviewedAt: true,
